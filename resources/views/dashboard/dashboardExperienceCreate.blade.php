...
@section('content')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="card">
        <div class="card-body">
            <form method="post" action="/dashboard/experience/">
            @csrf
                <div class="container row">
                    <div class="col-md-8">
                        <label for="form-title" class="form-label">Title</label>
                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="form-title" placeholder="Title" value="{{ old('title') }}" name="title">
                        @error('title')
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control @error('period') is-invalid @enderror" id="form-period" placeholder="Period" value="{{ old('period') }}" name="period">
                        @error('period')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-8">
                        ...
                        @enderror
                        <input type="hidden" name="desc" id="form-desc" value="{{ old('desc') }}">
